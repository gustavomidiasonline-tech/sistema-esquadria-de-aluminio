...
Controle Financeiro, Notas Fiscais e Gestão Fiscal
...
- **example-agent** - Example agent (customize or remove)

### Available Tasks

- **example-agent-task** - Example task (customize or remove)
...
4. Validate: `@squad-creator *validate-squad squad-financeiro`
